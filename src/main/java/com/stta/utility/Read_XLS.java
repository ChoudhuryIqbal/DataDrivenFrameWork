...
public class Read_XLS {
	...
	//to retieve Data ToRun flasg of test data
	public String [] retriveToRunFlagTestData(String wsName,String colName){
	...
	//To Retrive test data from test case data sheelt
	...
	//tot write result in test data and test case list sheet
